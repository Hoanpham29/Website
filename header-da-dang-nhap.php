                ...
                <div class="sidebar" id="sidebar">
                    <div class="sidebar-content">
                        <ul class="sidebar-list">
                            ...
                            <li><a href="phan-loai-ddn.php?query=Sữa+rửa+mặt" class="sidebar-item">Sữa rửa mặt</a></li>
                            <li><a href="phan-loai-ddn.php?query=Toner" class="sidebar-item">Toner</a></li>
                            <li><a href="phan-loai-ddn.php?query=Serum" class="sidebar-item">Serum</a></li>
                            <li><a href="phan-loai-ddn.php?query=Kem+dưỡng+ẩm" class="sidebar-item">Kem dưỡng ẩm</a></li>
                        </ul>
                    </div>
                </div>
